      ...
      <div className="nexradar-main" style={{ flex:1, display:'flex', flexDirection:'column', overflow:'hidden' }}>
        ...
        <div style={{ background:T.bg1, borderBottom:`1px solid ${T.border}`, padding: isMobile ? '0 10px' : '0 20px', height:56, display:'flex', alignItems:'center', gap: isMobile ? 8 : 14, flexShrink:0, position:'relative', overflowX: isMobile ? 'auto' : 'visible' }}>
          ...
          {headerPanel==='notifications'&&(
            <div style={{ position:'absolute', right: isMobile?4:20, top:64, width: isMobile?'calc(100vw - 8px)':340, maxHeight:480, display:'flex', flexDirection:'column', background:T.bg1, border:`1px solid ${T.border}`, borderRadius:10, boxShadow:'0 12px 40px rgba(0,0,0,0.5)', zIndex:9999, overflow:'hidden' }}>
          ...
          {headerPanel==='settings'&&(
            <div style={{ position:'absolute', right: isMobile?4:20, top:64, width: isMobile?'calc(100vw - 8px)':300, background:T.bg1, border:`1px solid ${T.border}`, borderRadius:10, boxShadow:'0 12px 40px rgba(0,0,0,0.5)', zIndex:9999, overflow:'hidden' }}>
          ...
          {headerPanel==='news'&&(
            <div style={{ position:'absolute', right: isMobile?4:20, top:64, width: isMobile?'calc(100vw - 8px)':360, maxHeight:520, display:'flex', flexDirection:'column', background:T.bg1, border:`1px solid ${T.border}`, borderRadius:10, boxShadow:'0 12px 40px rgba(0,0,0,0.5)', zIndex:9999, overflow:'hidden' }}>
              <div style={{ padding:'14px 16px', borderBottom:`1px solid ${T.border}`, display:'flex', justifyContent:'space-between', alignItems:'center', flexShrink:0 }}>
                <div style={{ display:'flex', alignItems:'center', gap:8 }}>
